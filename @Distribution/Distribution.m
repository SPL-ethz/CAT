classdef Distribution < hgsetget
    %% Class Distribution
    ...
    properties (Access=private)
        ...
        % restricted property
        % SEE ALSO
        % Distribution, Distribution.attributes, Distribution.classes, validateattributes
        choices% = struct('y',{{'boo','far'}});
        ...
        % SEE ALSO
        % Distribution, Distribution.choices, Distribution.attributes, validateattributes
        classes = struct('y',{{'numeric'}},...
            'boundaries',{{'numeric'}});
        ...
        % SEE ALSO
        % Distribution, Distribution.choices, Distribution.classes, validateattributes
        attributes = struct('y',{{'vector','real','finite','nonnegative'}},...
            'boundaries',{{'vector','real','finite','nonnegative'}});
    ...
    methods
        ...
        function set.y(O,value)
            ...
            % Checks: length > 1, non-decreasing
        ...
        function setPropertyValue(O,property,varargin)
                ...
                if isprop(O,property)
                    ...
                    if isfield(O.choices,property) && ~isempty(O.choices.(property))
                        if ~any(strcmp(value,O.choices.(property)))
                            error(['Distribution:set:' property],...
                    ...
                    error('Distribution:set:invalidproperty',...
            ...
            elseif isempty(varargin)
                ...
                error('Distribution:set:toomanyinputs','Too many inputs for set');
            end % if elseif else
