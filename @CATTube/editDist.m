...
Dgui.density.browse = uicontrol(Dgui.density.panel,...
    ...
    'String','Browse',...
    'Value',0,...
    'Callback',@(hObject,eventdata)O.browseVars(hObject,eventdata,'O.init_dist.y',O.gui.init.init_dist,'double'),...
    'Position',[460 10 50 30]...
    );
...
%% Function changedensity
    ...
    function distBrowse(~,~,classvarname,displayfield,classfilter)
