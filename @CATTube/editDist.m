...
Dgui.density.function = uicontrol(Dgui.density.panel,...
    ...
    'Units','pixels',...
    'Callback',@(hObject,Eventdata)changedensity(hObject,Eventdata),...
...
Dgui.density.activefield = Dgui.density.function;
...
%% Function changedensity
    ...
    function changedensity(hObject,~)
        ...
        % Save active field
        Dgui.density.activefield = hObject;
