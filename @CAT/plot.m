        ...
        for indO = 1:length(Oin)
            ...
            switch whichplot
                ...
                case 'proc_var'
                    ...
                    if isscalar(O.massmedium)
                        p_massmedium = O.massmedium*ones(size(O.calc_time)); 
                    else
                        p_massmedium = O.massmedium;
                    end % if else
                    ...
                    O.handles_objects{p} = [...
                        line(O.calc_time,O.calc_conc,...
                            'Color',color,'LineStyle',linestyle,'Marker',markerstyle,...
                            'Parent',axh(1)),...
                        line(O.calc_time,O.calc_conc./evalanonfunc(O.solubility,evalanonfunc(O.Tprofile,O.calc_time),evalanonfunc(O.ASprofile,O.calc_time)./O.massmedium)',...
                            'Color',color,'LineStyle',linestyle,'Marker',markerstyle,...
                            'Parent',axh(2)),...
                        line(O.calc_time,Tprof,...
                            'Color',color,'LineStyle',linestyle,'Marker',markerstyle,...
                            'Parent',axh(3))...
                        line(O.calc_time,p_massmedium,...
                            'Color',color,'LineStyle',linestyle,'Marker',markerstyle,...
                            'Parent',axh(4))...
                        ];
